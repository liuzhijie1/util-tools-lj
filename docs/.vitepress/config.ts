...
export default {
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/util-tools-lj/util-tools-lj' }],
    // editLinks: true,
    // editLink: {
    //   pattern: 'https://github.com/util-tools-lj/util-tools-lj/main/docs/:path',
    //   text: '为此页提供修改建议',
    // },
    nav: [
